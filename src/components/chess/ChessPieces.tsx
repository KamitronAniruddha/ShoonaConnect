...
import type { PieceStyleId } from '../../types/chess';
...
export const ChessPieceIcon: React.FC<ChessPieceProps> = ({
  type,
  color,
  styleId = 'classic',
  ...
  // Distinct fill and stroke styling
  let fill = isWhite ? '#ffffff' : '#1e1622';
  let stroke = isWhite ? '#331f28' : '#e2d3df';
  let accent = isWhite ? '#ffd6e8' : '#4a2840';

  if (styleId === 'neon') {
    fill = isWhite ? '#ff66aa' : '#00d2ff';
    stroke = isWhite ? '#ffffff' : '#e0f7ff';
    accent = isWhite ? '#ff3388' : '#0099cc';
  } else if (styleId === 'elegant') {
    fill = isWhite ? '#fff8e7' : '#231d27';
    stroke = isWhite ? '#c5a059' : '#d4af37';
    accent = isWhite ? '#fef3c7' : '#3f3147';
  }

  // Pure SVG paths for each piece
  switch (type) {
    case 'p':
      return (
      ...
      return (
        <svg viewBox="0 0 45 45" className={className}>
          ...
          >
            ...
            <path d="M 14,17 L 14,29.5 L 31,29.5 L 31,17 L 14,17 z" />
      ...
      return (
        <svg viewBox="0 0 45 45" className={className}>
          ...
          >
            ...
            <circle cx="13" cy="20" r="1" fill={stroke} />
          </g>
        </svg>
      );
      ...
      return (
        <svg viewBox="0 0 45 45" className={className}>
          ...
          >
            ...
            <path d="M 12,36 C 12.27,34.81 12.29,33.16 13,31 C 14,28 16,25.5 16,23 C 16,20.5 14.5,18.5 14.5,16 C 14.5,13.5 17.5,8 22.5,8 C 27.5,8 30.5,13.5 30.5,16 C 30.5,18.5 29,20.5 29,23 C 29,25.5 31,28 32,31 C 32.71,33.16 32.73,34.81 33,36" />
            <circle cx="22.5" cy="5.5" r="2.5" fill={fill} stroke={stroke} />
            <path d="M 17.5,26 L 27.5,26 M 15,30 L 30,30 M 22.5,10 L 22.5,13" />
            <path d="M 21,11.5 L 24,11.5" />
          </g>
        </svg>
      );
      ...
      return (
        <svg viewBox="0 0 45 45" className={className}>
          <g
            ...
            strokeLinejoin="round"
          >
            <path d="M 8,12 A 2 2 0 1 1 6,10 A 2 2 0 1 1 8,12 z" />
            <path d="M 16,7 A 2 2 0 1 1 14,5 A 2 2 0 1 1 16,7 z" />
            <path d="M 24.5,5 A 2 2 0 1 1 22.5,3 A 2 2 0 1 1 24.5,5 z" />
            <path d="M 33,7 A 2 2 0 1 1 31,5 A 2 2 0 1 1 33,7 z" />
            <path d="M 41,12 A 2 2 0 1 1 39,10 A 2 2 0 1 1 41,12 z" />
            <path d="M 9,26 C 17.5,24.5 30,24.5 36,26 L 38.5,13.5 L 31,25 L 22.5,10 L 14,25 L 6.5,13.5 L 9,26 z" />
            <path d="M 9,26 C 9,28 10.5,28 11.5,30 C 12.5,31.5 12.5,31 12,33.5 C 10.5,34.5 10.5,36 10,36 C 9.5,37.5 11,38.5 12,38.5 C 17.5,39.5 27.5,39.5 33,38.5 C 34,38.5 35.5,37.5 35,36 C 34.5,36 34.5,34.5 33,33.5 C 32.5,31 32.5,31.5 33.5,30 C 34.5,28 36,28 36,26" />
      ...
      return (
        <svg viewBox="0 0 45 45" className={className}>
          ...
          >
            ...
            <path d="M 11.5,37 C 17,40.5 28,40.5 33.5,37 C 34.5,30 35,24 35,16 C 35,16 32,15 28.5,19 C 25,23 22.5,23 22.5,23 C 22.5,23 20,23 16.5,19 C 13,15 10,16 10,16 C 10,24 10.5,30 11.5,37 z" />
